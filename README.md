...
## Requirements
- **[AFNetworking](https://github.com/AFNetworking/AFNetworking) 4.0 
- see AFNetworking

## Old versions
- **[AFNetworking](https://github.com/AFNetworking/AFNetworking) 3.0** *(However [old versions](#old-versions) are available at the other branches)*
